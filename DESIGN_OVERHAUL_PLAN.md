...
- **Step 9 Mobile-Pass (Garage portrait) ✅**: Portrait-Garage-Kamera reframed (Auto zentriert im oberen Band statt tief/links), mobiles Info-Panel als kompaktes Bottom-Sheet — Auto bleibt als Hero sichtbar. Run-HUD/Game-Over mobil gegengecheckt (passen via fluid-clamp). Landscape/Desktop unverändert.
